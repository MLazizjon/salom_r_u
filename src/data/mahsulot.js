...
// import breadImg5 from "../assets/products/bread/bread5.jpg";
...
// import saladImg23 from "../assets/products/salads/image23.png";
...
// import vegetableSaladImg17 from "../assets/products/vegetable-salads/vegetableSalad17.jpg";
...
// import shashlikImg5 from "../assets/products/shashlik/shashlik5.jpg";
...
export const products = {
  ...
  chicken: [
    {
      id: "chicken1",
      name: { uz: "Meksika qanotchalari", ru: "Крылья по мексиканской", en: "Mexican Wings" },
      price: "35000",
      image: chickenImg1,
    },
    {
      id: "chicken2",
      name: { uz: "Chiken file ", ru: "Чикен филе", en: "chicken fillet" },
      price: "110000",
      image: chickenImg2,
    },
    {
      id: "chicken3",
      name: { uz: "Qanotcha jiz", ru: "Крылешки Жиз", en: "fried chicken wing" },
      price: "128000",
      image: chickenImg3,
    },
    {
  ...
  shashlik: [
    {
      id: "shashlik9",
      name: { uz: "Qiyma shashlik", ru: "Молотый Шашлык", en: "Minced Shashlik" },
      price: "32500",
      image: shashlikImg9,
    },
    {
      id: "shashlik2",
      name: { uz: "Napoleon shashlik", ru: "Наполеон Шашлык", en: "Napoleon Shashlik" },
      price: "34900",
      image: shashlikImg2,
    },
    {
      id: "shashlik3",
      name: { uz: "Qo'y go'shti (Kuskovoy)", ru: "Баранина Кусковой", en: "Kuskovoy Lamb" },
      price: "34700",
      image: shashlikImg3,
    },
    {
      id: "shashlik6",
      name: { uz: "Dumba shashlik", ru: "Курдюк Шашлык", en: "Fat Tail Shashlik" },
      price: "32500",
      image: shashlikImg6,
    },
    {
      id: "shashlik7",
      name: { uz: "Tovuq shashligi (Shirin)", ru: "Куринный Шашлык Shirin", en: "Chicken Shashlik Shirin" },
      price: "29800",
      image: shashlikImg7,
    },
    {
      id: "shashlik8",
      name: { uz: "Cheburek", ru: "Чебурек", en: "Cheburek" },
      price: "41500",
      image: shashlikImg8,
    },
    {
      id: "shashlik4",
      name: { uz: "Mol go'shti (Kuskovoy)", ru: "Говяжий кусковой", en: "Kuskovoy Beef" },
      price: "35500",
      image: shashlikImg4,
    },
    {
      id: "shashlik1",
      name: { uz: "Rulet", ru: "Рулет", en: "Roll Shashlik" },
      price: "34900",
      image: shashlikImg1,
    },
  ],
  ...
  drinks: [
    {
      id: "drink2",
      name: { uz: "Coca-Cola 1L", ru: "Coca Cola 1л", en: "Coca-Cola 1L" },
      price: "17500",
      image: drinkImg2,
    },
    {
      id: "drink1",
      name: { uz: "Fanta 1L", ru: "Fanta 1л", en: "Fanta 1L" },
      price: "17500",
      image: drinkImg1,
    },
    {
    ...
    {
      id: "drink4",
      name: { uz: "Coca-Cola 1.5L", ru: "Coca Cola", en: "Coca-Cola 1.5L" },
      price: "23000",
      image: drinkImg4,
    },
    {
      id: "drink5",
      name: { uz: "Fanta 1.5L", ru: "Fanta", en: "Fanta 1.5L" },
      price: "23000",
      image: drinkImg5,
    },
    {
      id: "drink6",
      name: { uz: "Coca-Cola 0.25", ru: "Coca cola 0.25", en: "Coca-Cola 0.25" },
      price: "7000",
      image: drinkImg6,
    },
    {
      id: "drink7",
      name: { uz: "Fanta 0.25", ru: "Fanta 0.25", en: "Fanta 0.25" },
      price: "7000",
      image: drinkImg7,
    },
    {
      id: "drink8",
      name: { uz: "Coca-Cola NRG", ru: "Coca Cola NRG", en: "Coca-Cola NRG" },
      price: "12000",
      image: drinkImg8,
    },
    {
      id: "drink9",
      name: { uz: "Bon Aqua mineral suvi", ru: 'Мин вода "Bon Aqua"', en: "Bon Aqua Mineral Water" },
      price: "8000",
      image: drinkImg9,
    },
    {
      id: "drink10",
      name: { uz: "Pepsi 1L", ru: "пепси 1л", en: "Pepsi 1L" },
      price: "17500",
      image: drinkImg10,
    },
    {
      id: "drink11",
      name: { uz: "Bliss sharbati 1L", ru: 'Сок "Blis" 1l', en: "Bliss Juice 1L" },
      price: "20000",
      image: drinkImg11,
    },
    {
      id: "drink12",
      name: { uz: "Borjomi", ru: "Боржоми", en: "Borjomi" },
      price: "22000",
      image: drinkImg12,
    },
    {
      id: "drink13",
      name: { uz: "Chortoq", ru: "Чорток", en: "Chortoq" },
      price: "20000",
      image: drinkImg13,
    },
    {
      id: "drink14",
      name: { uz: "Red Bull", ru: "Red Bull.", en: "Red Bull" },
      price: "32000",
      image: drinkImg14,
    },
    {
      id: "drink15",
      name: { uz: "Bonaqua 1L", ru: "Bonaqua 1l", en: "Bonaqua 1L" },
      price: "8000",
      image: drinkImg15,
    },
    {
  ...
  beer: [
    {
      id: "beer1",
      name: { uz: "Zatecky Gus 'Разлив'", ru: 'Затеки Гусь "Разлив"', en: 'Zatecky Gus "Spill"' },
      price: "21000",
      image: beerImg1,
    },
    {
  ...
  vodka: [
    {
      id: "vodka1",
      name: { uz: "Red Square 0.5", ru: "Красный square 0.5", en: "Red Square 0.5" },
      price: "121000",
      image: vodkaImg1,
    },
    {
      id: "vodka2",
      name: { uz: "Ballantines 0.7l", ru: "Баллантайнс 0.7л", en: "Ballantines 0.7l" },
      price: "556000",
      image: vodkaImg2,
    },
    {
      id: "vodka3",
      name: { uz: "Jameson 0.5l", ru: "Джеймсон 0.5л", en: "Jameson 0.5l" },
      price: "491000",
      image: vodkaImg3,
    },
    {
  ...
  desserts: [
    {
      id: "dessert1",
      name: { uz: "Chizkeyk", ru: "Cheesecake", en: "Cheesecake" },
      price: "47000",
      image: dessertImg1,
    },
    {
      id: "dessert2",
      name: { uz: "Shokoladli fondan", ru: "Шоколадный fondan", en: "Chocolate Fondant" },
      price: "38000",
      image: dessertImg2,
    },
    {
